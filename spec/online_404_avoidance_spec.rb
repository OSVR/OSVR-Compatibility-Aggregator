...
describe OsvrCompatibilityAggregator::Connection, '#head' do
  it 'errors if the URL is 404' do
    expect { OsvrCompatibilityAggregator::Connection.head 'https://raw.githubusercontent.com/OSVR/OSVR-Core/master/__xyzzy__' }.to raise_error(Faraday::ResourceNotFound)
  end
end
